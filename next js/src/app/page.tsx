...
import { ArrowRight, Zap, Workflow, Cloud, Code, Database, Server, GitBranch } from "lucide-react";
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
              <Button size="lg" className="btn-primary text-lg px-8 py-6 shadow-glow" asChild>
                <Link href="/signup">
                  Get Started Free
